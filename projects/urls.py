...
from .views import show_latest_projects,show_project, show_similar_project, create_project, create_comment, reply_comment, report_project, rate_project, cancel_project, all_categories
...
urlpatterns = [
    ...
    path('latest', show_latest_projects),
